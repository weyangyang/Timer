...
import imageloader.cache.disc.impl.UnlimitedDiscCache;
import imageloader.cache.disc.naming.FileNameGenerator;
import imageloader.cache.memory.MemoryCacheAware;
...
import imageloader.core.download.NetworkDeniedImageDownloader;
import imageloader.core.download.SlowNetworkImageDownloader;
...
public final class ImageLoaderConfiguration {
	...
	public static class Builder {
		 ...
		 * {@link imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link imageloader.cache.disc.impl.TotalSizeLimitedDiscCache TotalSizeLimitedDiscCache}
		 ...
		 * By default: disc cache is unlimited.<br />
		 * <b>NOTE:</b> If you use this method then
		 * {@link imageloader.cache.disc.impl.FileCountLimitedDiscCache FileCountLimitedDiscCache}
		 * will be used as disc cache. You can use {@link #discCache(DiscCacheAware)} method for introduction your own
		 * implementation of {@link DiscCacheAware}
		 */
		 ...
		 * Default value -
		 * {@link imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value -
		 * {@link imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Default value - {@link imageloader.cache.disc.impl.UnlimitedDiscCache
		 * UnlimitedDiscCache}. Cache directory is defined by
		 * {@link imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Consider {@link imageloader.utils.L#disableLogging()} to disable ImageLoader logging completely (even error logs)
		 */
