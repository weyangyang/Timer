...
public class FileUtils {
	...
	public static String getCachePath() {
		File f = CoreConfig.getContext().getCacheDir();
		if (null == f) {
			return null;
		} else {
	...
	static public boolean writeLogFile(String sfile, String msg,int cacheSize,String cacheDir) {
		...
		try {
			...
			if (file.exists() && file.length() > cacheSize * 1024) {
				...
				//PreferenceUtils.setPrefString(CoreConfig.getContext(), PreferenceUtils.SP_LOG_DIR_PATH,filebak.getParent());
				if (filebak.exists()) {
					filebak.delete();
				}
...
//			msg = dateTime + msg + "\n";
			msg =  msg + "\r\n";
//			int seq = PreferenceUtils.getPrefInt(CoreConfig.getContext(), PreferenceUtils.SP_SEQ_NUM, 1);
//			seq ++;
//			PreferenceUtils.setPrefInt(CoreConfig.getContext(), PreferenceUtils.SP_SEQ_NUM,seq);
